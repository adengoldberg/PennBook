 ...
 */
 ...
 //Key-value store that stores if a given user is online or not. Built of KVS given by class.
...
(function() {
   ...
   */
  keyvaluestore.prototype.update = function(keyword, inx, value_input, callback) {
    var self = this;
    if (self.inx === -1){
      callback("Error using table - call init first!", null)
      return
